...
const CertificationCheckbox = () => {
  ...
  return (
    <Box width="100%">
      ...
      <CheckboxGroup value={selectedCertifications} onChange={handleCertificationChange}>
        <Flex wrap="wrap" gap={3}>
          {/* Each Checkbox now updates the selectedCertifications state */}
          <Checkbox value="NR" sx={{
